...
try {
  app.mode = localStorage.getItem("richkkok-qa-mode") === "demo" ? "demo" : "real";
} catch {}
app.repo = new Repository(
  app.mode === "demo" ? "richkkok-qa-demo-v2" : "richkkok-qa-v2",
);
...
const channel =
  typeof BroadcastChannel !== "undefined"
    ? new BroadcastChannel("richkkok-qa-updates")
    : null;
channel &&
  (channel.onmessage = () => {
...
async function switchMode(mode) {
  ...
  app.mode = mode;
  try {
    localStorage.setItem("richkkok-qa-mode", mode);
  } catch {}
  app.repo = new Repository(
    mode === "demo" ? "richkkok-qa-demo-v2" : "richkkok-qa-v2",
  );
